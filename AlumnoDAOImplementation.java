 ...
 */
@Repository
public class AlumnoDAOImplementation implements AlumnoRepository{
    ...
    @Override
    public int addAlumnoSP(Alumno alumno, String nombre, String apellidoPaterno, String apellidoMaterno) {
        return alumno.getIdalumno();
    }

    @Override
    public void updateAlumnoSP(int idAlumno, String nombre, String apellidoPaterno, String apellidoMaterno) {
        entityManager.merge(idAlumno);
    }

    @Override
    public void deleteAlumnoSP(Long idAlumno) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public List<Alumno> GetAllAlumnoSP() {
        TypedQuery<Alumno> query = entityManager.createQuery("FROM Alumno", Alumno.class);
        List <Alumno> alumnos = query.getResultList();
        return alumnos;
    }

    @Override
    public List<Alumno> getByIdAlumnoSP(int idAlumno) {
        TypedQuery<Alumno> query = entityManager.createQuery("FROM Alumno where idalumno=: idAlumno", Alumno.class);
